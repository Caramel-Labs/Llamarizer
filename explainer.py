...
st.set_page_config(page_title="Llama Explainer", page_icon=":llama:", layout="centered")
...
if prompt:
    modified_prompt = f"""Explain the following text to me as briefly as possible: \n\n{prompt} \n\nExplanation: """
